...
if ($package) {
    ...
    $result = Get-AppxPackage -AllUsers | Where-Object { $_.PackageFullName -eq $packageFullName } | Remove-AppxPackage -AllUsers
...
$installerURL = "https://go.microsoft.com/fwlink/?linkid=2196106&clcid=0x409&culture=en-us&country=us"  # Replace with actual URL
